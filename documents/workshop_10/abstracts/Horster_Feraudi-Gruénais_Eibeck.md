...
In Graz, Marietta will present the poster and the editor with all these features, and will hopefully have in her hands as well a first volume of print-on-demand/E-book (_Ephemeris Epigraphica Electronica_) as an example of the potential Output of such digital editions.
