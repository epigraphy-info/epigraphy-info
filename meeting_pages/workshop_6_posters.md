---
layout: page
title: Posters session at 6th Epigraphy.info Workshop
...
**[Posters on GitHub]({{ site.baseurl }}{% link documents/workshop_6/Readme.txt%}){:target="_blank" rel="noopener"}** - will be added on 20 Oct 2021

---

## Poster 1 - Template

Name of the author, affiliation, contact

* [Poster 1 online](hyperlink to online contents){:target="_blank" rel="noopener"}

* [Poster 1 on Epigraphy.info GitHub]({{ site.baseurl }}{% link documents/workshop_6/Readme.txt %}){:target="_blank" rel="noopener"}

<img src='{{site.baseurl}}/documents/workshop_6/Readme.txt' style="width:100%;" alt="Poster 1" align="middle">

---

## Poster 1 - replace with real data
